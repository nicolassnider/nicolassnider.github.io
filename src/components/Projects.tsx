                    ...
                    {project.githubUrl && (
                      <div className="relative group/tooltip">
                        <a 
                          ...
                          className="p-2.5 rounded-full bg-gray-100 hover:bg-purple-100 dark:bg-gray-800 dark:hover:bg-purple-950/50 text-gray-600 hover:text-purple-600 dark:text-gray-400 dark:hover:text-purple-400 border border-gray-200/50 dark:border-gray-700/50 hover:border-purple-300 dark:hover:border-purple-800 transition-all duration-300 hover:scale-110 shadow-sm flex items-center justify-center"
                          aria-label={t['projects.viewSource'].replace('{{project}}', project.title)}
                        >
                          <GitHubIcon className="w-5 h-5" />
                        </a>
                        <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2.5 py-1 text-xs font-semibold text-white bg-purple-600 dark:bg-purple-500 rounded-md opacity-0 scale-75 group-hover/tooltip:opacity-100 group-hover/tooltip:scale-100 transition-all duration-200 origin-bottom pointer-events-none whitespace-nowrap shadow-lg z-20 flex items-center gap-1">
                          {t['projects.tooltip.github']}
                          <span className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-purple-600 dark:border-t-purple-500"></span>
                        </span>
                      </div>
                    )}
                    {project.youtubeUrl && (
                      <div className="relative group/tooltip">
                        <a 
                          ...
                          target="_blank" 
                          rel="noopener noreferrer"
                          className="p-2.5 rounded-full bg-gray-100 hover:bg-red-100 dark:bg-gray-800 dark:hover:bg-red-950/50 text-gray-600 hover:text-red-600 dark:text-gray-400 dark:hover:text-red-400 border border-gray-200/50 dark:border-gray-700/50 hover:border-red-300 dark:hover:border-red-900 transition-all duration-300 hover:scale-110 shadow-sm flex items-center justify-center"
                          aria-label={t['projects.watchVideo']}
                        >
                          <YoutubeIcon className="w-5 h-5" />
                        </a>
                        <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2.5 py-1 text-xs font-semibold text-white bg-red-600 dark:bg-red-500 rounded-md opacity-0 scale-75 group-hover/tooltip:opacity-100 group-hover/tooltip:scale-100 transition-all duration-200 origin-bottom pointer-events-none whitespace-nowrap shadow-lg z-20 flex items-center gap-1">
                          {t['projects.tooltip.youtube']}
                          <span className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-red-600 dark:border-t-red-500"></span>
                        </span>
                      </div>
                    )}
                  </div>
